...
export interface InventoryItem { id: string; sku: string; barcode: string; category: string; name: string; brand: string; model: string; attributes: Record<string, unknown>; supplierId: string; costMinor: number; salePriceMinor: number; currency: string; quantity: number; reorderLevel: number; trackStock: boolean; procedureCode: string; unit: string; batchNumber: string; expirationDate: string; expired: boolean; notes: string; durationMinutes: number; bookable: boolean; lowStock: boolean; archived: boolean; version: number; updatedAt: string }

export interface StockMovement { id: string; type: string; previousQuantity: number; quantityChange: number; resultingQuantity: number; reason: string; referenceType: string; referenceId: string; user: string; createdAt: string }
