...
interface Prescription { id: string; prescriptionNumber: string; patientName: string; type: "spectacle" | "contact_lens" | "medication"; od: Record<string, string>; os: Record<string, string>; details: Record<string, string>; notes: string; issuedAt: string; expiresAt: string; doctor: string; signed: boolean; signedBy: string; signedAt: string }
