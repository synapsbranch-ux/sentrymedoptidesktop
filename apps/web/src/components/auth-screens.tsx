...
export function SetupScreen() {
  ...
  const [submitting, setSubmitting] = React.useState(false);
  const [form, setForm] = React.useState({ clinicName: "", address: "", phone: "", email: "", doctorName: "", doctorUsername: "", doctorEmail: "", password: "", currency: "HTG", timezone: Intl.DateTimeFormat().resolvedOptions().timeZone || "America/Port-au-Prince", backupDirectory: "" });
